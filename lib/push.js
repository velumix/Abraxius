...
class Pusher {
  ...
  async push(localFile) {
    ...
    // Studio canonicalizes script line endings to LF. Normalize before diffing
    // and verification so Windows CRLF files do not appear wholly unrelated.
    ...
    const edits = exists
      ? buildSourceEdits(currentResult.source, newSource)
